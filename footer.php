...
?>
	...
	<footer id="colophon" class="site-footer">
		...
		<div class="footerContact pageWidth flex-container">
			...
			<a href="https://ardensauto.com"><img src="/assets/scss/wp-content/uploads/2019/01/ArdensLogoSmall.png" class="footerLogo" alt="ardens automotive hospital logo"></a>
				...
				<div class="copyrightContentWrap navWidth">
					...
					<div id="copyrightWrap">
						...
						<div id="copyrightContent">
							...
							<svg class="icon icon-copyright"><use xlink:href="#icon-copyright"></use></svg><p>&nbsp;<script>document.write(new Date().getFullYear());</script> Arden's Automotive Hospital</p>
